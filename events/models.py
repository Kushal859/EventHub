...
class Resevation(models.Model):
    ...
    # ForeignKey = "many reservations -> one event"
    # on_delete=CASCADE = if the event is deleted, delete its reservations too
    # related_name='reservations' = lets you do event.reservations.all()
